  ...
  https.get(url, function(response) {
    ...
    response.on("data", function(data) {
      ...
      const resultHTML = `
        ...
        <body style = 'background-image: url(https://cdn.glitch.global/2d314d96-5201-491d-ac70-4515d0bb864d/weather-img.jpg?v=1685691280603); background-repeat: no-repeat;
